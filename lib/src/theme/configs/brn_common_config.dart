...
class BrnCommonConfig extends BrnBaseConfig {
  ...
  BrnCommonConfig({
    ...
    /// 基础文字重要色
    this.colorTextImportant: const Color(0xFF666666),
    ...
    /// 标题字体
    /// 名称/页面大标题
    this.fontSizeHeadLg: 22,

    /// 标题字体
    /// 内容模块标题/一级标题
    this.fontSizeHead: 18,

    /// 子标题字体
    /// 标题/录入文字/大按钮文字/二级标题
    this.fontSizeSubHead: 16,
    ...
    /// 辅助字体-普通
    this.fontSizeCaption: 12,

    ///辅助字体-小
    this.fontSizeCaptionSm: 11,
    ...
    /// 边框尺寸
    this.borderWidthSm: 0.5,
    this.borderWidthMd: 1,
    this.borderWidthLg: 2,
