...
class BrnTagConfig extends BrnBaseConfig {
  ...
  late Color selectedTagBackgroundColor;
  ...
  /// default value is 75
  late double tagWidth;

  /// 标签最小宽度
  /// default value is 75
  late double tagMinWidth;
  ...
  BrnTagConfig(
    ...
    this.selectTagTextStyle = selectTagTextStyle ??
        BrnTextStyle(
            fontWeight: FontWeight.w600,
            color: BrnDefaultConfigUtils.defaultCommonConfig.brandPrimary,
            fontSize: BrnDefaultConfigUtils.defaultCommonConfig.fontSizeCaption);
    this.tagBackgroundColor =
        tagBackgroundColor ?? BrnDefaultConfigUtils.defaultCommonConfig.fillBody;
    this.selectedTagBackgroundColor =
        selectedTagBackgroundColor ?? BrnDefaultConfigUtils.defaultCommonConfig.brandPrimary;
    this.tagRadius = tagRadius ?? BrnDefaultConfigUtils.defaultCommonConfig.radiusXs;
    this.tagHeight = tagHeight ?? 34;
    this.tagWidth = tagWidth ?? 75;
    this.tagMinWidth = tagMinWidth ?? 75;
  }
